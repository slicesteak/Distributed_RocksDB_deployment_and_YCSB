...
public class CoreWorkload extends Workload {
   ...
   * Default value of the field name prefix.
   */
  public static final String ZIPF_CONSTANT = "zipfconstant";
  ...
  protected static NumberGenerator getFieldLengthGenerator(Properties p) throws WorkloadException {
    ...
    //   double myZipfFactor = Double.parseDouble(p.getProperty(ZIPF_CONSTANT, "0.3"));
    //   System.err.println("(line 408) success get myzipf factor:" + myZipfFactor);

      fieldlengthgenerator = new ZipfianGenerator(minfieldlength, fieldlength);
    //   fieldlengthgenerator = new ZipfianGenerator(minfieldlength, fieldlength, myZipfFactor);
  ...
  public void init(Properties p) throws WorkloadException {
    ...
    //   double myZipfFactor = Double.parseDouble(p.getProperty(ZIPF_CONSTANT, "0.3"));
    //   System.err.println("(line 529) success get myzipf factor:" + myZipfFactor);
    ...
    //   double myZipfFactor = Double.parseDouble(p.getProperty(ZIPF_CONSTANT, "0.3"));
    //   System.err.println("(line 558) success get myzipf factor:" + myZipfFactor);
      
    //   scanlength = new ZipfianGenerator(minscanlength, maxscanlength, myZipfFactor);
