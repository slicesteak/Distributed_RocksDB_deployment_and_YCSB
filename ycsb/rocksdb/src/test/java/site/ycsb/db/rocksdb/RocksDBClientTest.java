...
//   private RocksDBRemoteClient remote_instance;


  @Before
  public void setup() throws Exception {
    instance = new RocksDBClient();
    // remote_instance = new RocksDBRemoteClient();
  ...
  public void insertAndRead() throws Exception {
    ...
    Status insertResult = Status.OK;
    // instance.testAll(); // 这里试试

    System.out.println("called insert And read");
    
    insertResult = instance.insert(MOCK_TABLE, MOCK_KEY0, MOCK_DATA);
    ...
    System.out.println("insertAndRead read test");
    
    Status readResult;
    readResult = instance.read(MOCK_TABLE, MOCK_KEY0, fields, resultParam);

    assertEquals(Status.OK, readResult);
    System.out.println("insertAndRead pass");
  }
