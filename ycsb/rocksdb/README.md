...
Now you are ready to run! First, load the data:
    ...
    ./bin/ycsb load rocksdb -s -P workloads/workloade -p rocksdb.dir=/tmp/ycsb-rocksdb-data

Then, run the workload:

    ./bin/ycsb run rocksdb -s -P workloads/workloade -p rocksdb.dir=/tmp/ycsb-rocksdb-data
